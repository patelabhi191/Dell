#!/bin/bash
tot=0; totf=0
suites="test-data test-ui test-contrib test-yf-me-contrib test-yf-highlights test-bills test-billpay test-import test-dates test-plan test-notes test-mobile test-ui-edits"

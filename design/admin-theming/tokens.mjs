...
export const THEMES = [
  { id: 'terminal', label: 'Terminal Classic', note: 'Charcoal chrome, trapezoid plaque',
    tok: {
      ...
      'card-face': '#f4f1e8', 'logo-ink': '#f2f4f6', 'logo-muted': '#9aa0a6', 'logo-spade': '#14161a', 'logo-bar': '#c9a227',
  ...
  { id: 'slot', label: 'Slot Machine', note: 'Red carnival, marquee bulbs, confetti',
    tok: {
      ...
      'card-face': '#ffffff', 'logo-ink': '#17244d', 'logo-muted': '#6d7699', 'logo-spade': '#17244d', 'logo-bar': '#f7b500',
  ...
  { id: 'neon', label: 'Neon Terminal', note: 'Indigo, flickering neon tube',
    tok: {
      ...
      'card-face': '#f7f2ff', 'logo-ink': '#ffffff', 'logo-muted': '#a892d8', 'logo-spade': '#241350', 'logo-bar': '#00e5ff',
  ...
  { id: 'tropical', label: 'Tropical Table', note: 'Turquoise felt, arched plaque',
    tok: {
      ...
      'card-face': '#ffffff', 'logo-ink': '#0f3d38', 'logo-muted': '#5c8c85', 'logo-spade': '#0f3d38', 'logo-bar': '#ffb703',

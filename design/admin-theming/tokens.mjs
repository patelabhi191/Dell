...
export const THEMES = [
  { id: 'terminal', label: 'Terminal Classic', note: 'Charcoal chrome, trapezoid plaque',
    tok: {
      ...
      'card-face': '#f4f1e8', 'logo-ink': '#14161a', 'logo-muted': '#5f636a', 'logo-spade': '#14161a', 'logo-bar': '#c9a227',
  ...
  { id: 'slot', label: 'Slot Machine', note: 'Red carnival, marquee bulbs, confetti',
    tok: {
      ...
      'card-face': '#ffffff', 'logo-ink': '#17244d', 'logo-muted': '#616a8c', 'logo-spade': '#101317', 'logo-bar': '#f7b500',
  ...
  { id: 'neon', label: 'Neon Terminal', note: 'Indigo, flickering neon tube',
    tok: {
      ...
      'card-face': '#f7f2ff', 'logo-ink': '#241350', 'logo-muted': '#6b5b96', 'logo-spade': '#150f1c', 'logo-bar': '#00e5ff',
  ...
  { id: 'tropical', label: 'Tropical Table', note: 'Turquoise felt, arched plaque',
    tok: {
      ...
      'card-face': '#ffffff', 'logo-ink': '#0f3d38', 'logo-muted': '#3f6e68', 'logo-spade': '#101a17', 'logo-bar': '#ffb703',
